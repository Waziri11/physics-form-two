# Physics for Secondary Schools: Student’s Book Form Two — ADT Bundle Reference
...
**Physics for Secondary Schools: Student’s Book Form Two** — This is an English-language Form Two physics textbook for lower secondary students in Tanzania, published by the Tanzania Institute of Education for the Ordinary Secondary curriculum. It covers electricity, magnetism, light, refraction, and optical instruments, with topics such as static and current electricity, mirrors, lenses, and simple devices like microscopes and telescopes. The book uses a competency-based, activity-centered approach, combining explanations with experiments, revision exercises, projects, and everyday applications to build practical scientific understanding.
...
├── Physics-Form-2-Final.db                    # SQLite database (pipeline state)
├── Physics-Form-2-Final.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania, Ministry of Education, Science and Technology, approving the Physics for Secondary Schools Student’s Book Form Two as a textbook for Tanzanian secondary schools; dated 31 May 2025 and signed by the Commissioner for Education, Dr Lyabwene M. Mtahabwa.",
  "gl001": "absolute refractive index",
  "gl001_def": "the refractive index found by comparing the speed of light in vacuum with its speed in a material"
}
```
...
```json
{
  "absolute refractive index": {
    "word": "absolute refractive index",
    "definition": "the refractive index found by comparing the speed of light in vacuum with its speed in a material",
    "variations": ["absolute refractive index","absolute refractive indices"],
    "emoji": "🌌🔢"
  }
}
```
...
```json
{
  "title": "Physics for Secondary Schools: Student’s Book Form Two",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
| Original PDF | `Physics-Form-2-Final.pdf` |
| Pipeline database | `Physics-Form-2-Final.db` (SQLite) |
